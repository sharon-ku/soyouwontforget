...
class IntroDialogBox {
  ...
  update(introDialogsList, currentIntroDialogIndex) {
    this.currentDialogNumber = currentIntroDialogIndex;

    // Display box
    this.displayBox();

    this.speaker.string =
      introDialogsList.dialogs[this.currentDialogNumber].speaker;
    this.text.string =
      introDialogsList.dialogs[this.currentDialogNumber].dialog;
  ...
  mousePressed(mouse) {
    if (this.mouseOverlapsRectangle(mouse)) {
      ...
      console.log(currentIntroDialogIndex, this.currentDialogNumber);
      return true;
    } else {
      return false;
    }
